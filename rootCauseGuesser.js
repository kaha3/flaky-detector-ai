...
// Use CLI-provided or default paths
const outputDir = process.env.FLAKY_OUTPUT_DIR || path.resolve(__dirname, 'reports');
const inputPath = path.resolve(outputDir, 'flaky-report.json');
const outputPath = path.resolve(outputDir, 'root-cause-report.json');
